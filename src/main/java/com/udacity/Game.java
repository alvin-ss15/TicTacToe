...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        {
            String msg = Character.toUpperCase(symbol[i])+" wins";
            if(grid[0][0] == symbol[i] && grid[1][1] == symbol[i] && grid[2][2] == symbol[i])
            {
                result = msg;
            }
            else if(grid[2][0] == symbol[i] && grid[1][1] == symbol[i] && grid[0][2] == symbol[i])
            {
                result = msg;
            }
            for(int j=0;j<3;j++)
            {
                ...
                else if(grid[j][0] == symbol[i] && grid[j][1] == symbol[i] && grid[j][2] == symbol[i])
                {
                    result = msg;
                }
            }
